...
namespace Grilar\Media\Facades;

use Grilar\Media\RvMedia as BaseRvMedia;
 ...
 * @method static bool deleteFile(\Grilar\Media\Models\MediaFile $file)
 * @method static bool deleteThumbnails(\Grilar\Media\Models\MediaFile $file)
 ...
 * @method static \Grilar\Media\RvMedia addSize(string $name, string|int $width, string|int $height = 'auto')
 * @method static \Grilar\Media\RvMedia removeSize(string $name)
 ...
 * @method static bool generateThumbnails(\Grilar\Media\Models\MediaFile $file, \Illuminate\Http\UploadedFile|null $fileUpload = null)
