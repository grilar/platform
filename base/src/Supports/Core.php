...
namespace Grilar\Base\Supports;

use Grilar\Base\Events\LicenseActivated;
use Grilar\Base\Events\LicenseActivating;
use Grilar\Base\Events\LicenseDeactivated;
use Grilar\Base\Events\LicenseDeactivating;
use Grilar\Base\Events\LicenseInvalid;
use Grilar\Base\Events\LicenseRevoked;
use Grilar\Base\Events\LicenseRevoking;
use Grilar\Base\Events\LicenseUnverified;
use Grilar\Base\Events\LicenseVerified;
use Grilar\Base\Events\LicenseVerifying;
use Grilar\Base\Events\SystemUpdateAvailable;
use Grilar\Base\Events\SystemUpdateCachesCleared;
use Grilar\Base\Events\SystemUpdateCachesClearing;
use Grilar\Base\Events\SystemUpdateChecked;
use Grilar\Base\Events\SystemUpdateChecking;
use Grilar\Base\Events\SystemUpdateDBMigrated;
use Grilar\Base\Events\SystemUpdateDBMigrating;
use Grilar\Base\Events\SystemUpdateDownloaded;
use Grilar\Base\Events\SystemUpdateDownloading;
use Grilar\Base\Events\SystemUpdateExtractedFiles;
use Grilar\Base\Events\SystemUpdateExtractingFiles;
use Grilar\Base\Events\SystemUpdatePublished;
use Grilar\Base\Events\SystemUpdatePublishing;
use Grilar\Base\Events\SystemUpdateUnavailable;
use Grilar\Base\Exceptions\LicenseInvalidException;
use Grilar\Base\Exceptions\LicenseIsAlreadyActivatedException;
use Grilar\Base\Exceptions\MissingCURLExtensionException;
...
final class Core
{
    ...
    private string $licenseUrl = 'https://license.grilar.com';
    ...
    /**
     * @throws \Grilar\Base\Exceptions\LicenseInvalidException
     * @throws \Grilar\Base\Exceptions\LicenseIsAlreadyActivatedException
     */
