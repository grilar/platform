...
use Grilar\Base\Supports\EmailHandler as EmailHandlerSupport;
use Illuminate\Support\Facades\Facade;

/**
 * @method static \Grilar\Base\Supports\EmailHandler setModule(string $module)
 * @method static string getType()
 * @method static \Grilar\Base\Supports\EmailHandler setType(string $type)
 * @method static string|null getTemplate()
 * @method static \Grilar\Base\Supports\EmailHandler setTemplate(string|null $template)
 * @method static array getCoreVariables()
 * @method static array getTwigFunctions()
 * @method static \Grilar\Base\Supports\EmailHandler setVariableValue(string $variable, string $value, string|null $module = null)
 * @method static array getVariableValues(string|null $module = null)
 * @method static \Grilar\Base\Supports\EmailHandler setVariableValues(array $data, string|null $module = null)
 * @method static \Grilar\Base\Supports\EmailHandler addTemplateSettings(string $module, array|null $data, string $type = 'plugins')
 ...
 *
 * @see \Grilar\Base\Supports\EmailHandler
 */
