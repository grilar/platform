    ...
    DataTable.ext.buttons.excel = {
        ...
        text: (dt) => {
            return (
                ...
                dt.i18n(
                    'buttons.excel',
                    GrilarVariables.languages.tables.excel ? GrilarVariables.languages.tables.excel : 'Excel'
                )
            )
        },
    ...
    DataTable.ext.buttons.export = {
        ...
        text: (dt) => {
            return (
                ...
                dt.i18n(
                    'buttons.export',
                    GrilarVariables.languages.tables.export ? GrilarVariables.languages.tables.export : 'Export'
                ) +
                '&nbsp;<span class="caret"/>'
            )
        },
    ...
    DataTable.ext.buttons.csv = {
        ...
        text: (dt) => {
            return (
                ...
                dt.i18n(
                    'buttons.csv',
                    GrilarVariables.languages.tables.csv ? GrilarVariables.languages.tables.csv : 'CSV'
                )
            )
        },
    ...
    DataTable.ext.buttons.print = {
        ...
        text: (dt) => {
            return (
                ...
                dt.i18n(
                    'buttons.print',
                    GrilarVariables.languages.tables.print ? GrilarVariables.languages.tables.print : 'Print'
                )
            )
        },
    ...
    DataTable.ext.buttons.reset = {
        ...
        text: (dt) => {
            return (
                ...
                dt.i18n(
                    'buttons.reset',
                    GrilarVariables.languages.tables.reset ? GrilarVariables.languages.tables.reset : 'Reset'
                )
            )
        },
    ...
    DataTable.ext.buttons.reload = {
        ...
        text: (dt) => {
            return (
                ...
                dt.i18n(
                    'buttons.reload',
                    GrilarVariables.languages.tables.reload ? GrilarVariables.languages.tables.reload : 'Reload'
                )
            )
        },
    ...
    class TableManagement {
        ...
        handleActionsRow() {
            ...
            $(document).on('click', '.delete-many-entry-trigger', (event) => {
                ...
                if (ids.length === 0) {
                    Grilar.showError(
                        GrilarVariables.languages.tables.please_select_record
                            ? GrilarVariables.languages.tables.please_select_record
