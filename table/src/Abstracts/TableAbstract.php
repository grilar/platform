...
namespace Grilar\Table\Abstracts;
...
use Grilar\Table\Abstracts\Concerns\HasActions;
use Grilar\Table\Abstracts\Concerns\HasBulkActions;
use Grilar\Table\Abstracts\Concerns\HasFilters;
use Grilar\Table\BulkActions\DeleteBulkAction;
use Grilar\Table\Columns\CheckboxColumn;
use Grilar\Table\Columns\Column;
use Grilar\Table\Columns\DateColumn;
use Grilar\Table\Columns\EmailColumn;
use Grilar\Table\Columns\EnumColumn;
use Grilar\Table\Columns\IdColumn;
use Grilar\Table\Columns\ImageColumn;
use Grilar\Table\Columns\LinkableColumn;
use Grilar\Table\Columns\NameColumn;
use Grilar\Table\Columns\RowActionsColumn;
use Grilar\Table\Supports\Builder as CustomTableBuilder;
use Grilar\Table\Supports\TableExportHandler;
use Closure;
...
abstract class TableAbstract extends DataTable
{
    ...
    /**
     * @var \Closure(\Grilar\Table\DataTables $table): \Illuminate\Http\JsonResponse
     */
    protected Closure $onAjaxCallback;

    /**
     * @var \Grilar\Table\Columns\Column[]
     */
    ...
    /**
     * @param \Closure(\Grilar\Table\DataTables $table): \Illuminate\Http\JsonResponse $onAjaxCallback
     */
    ...
    /**
     * @param \Grilar\Table\Columns\Column[] $columns
     */
