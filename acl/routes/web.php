...
use Grilar\ACL\Http\Controllers\Auth\ForgotPasswordController;
use Grilar\ACL\Http\Controllers\Auth\LoginController;
use Grilar\ACL\Http\Controllers\Auth\ResetPasswordController;
use Grilar\ACL\Http\Controllers\UserController;
use Grilar\Base\Facades\BaseHelper;
use Illuminate\Support\Facades\Route;

Route::group(['namespace' => 'Grilar\ACL\Http\Controllers', 'middleware' => ['web', 'core']], function () {
