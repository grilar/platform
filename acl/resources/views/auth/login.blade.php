...
@section('content')
    ...
    {!! Form::open(['route' => 'access.login', 'class' => 'login-form']) !!}
        <div class="form-group mb-3" id="emailGroup">
            ...
            {!! Form::text('username', request()->input('email', old('username', BaseHelper::hasDemoModeEnabled() ? config('core.base.general.demo.account.username', 'grilar') : null)), ['class' => 'form-control', 'placeholder' => trans('core/acl::auth.login.username')]) !!}
        </div>
