...
@if ($canChangeProfile)
    @push('footer')
        ...
        {!! JsValidator::formRequest(\Grilar\ACL\Http\Requests\UpdateProfileRequest::class, '#profile-form'); !!}
        {!! JsValidator::formRequest(\Grilar\ACL\Http\Requests\UpdatePasswordRequest::class, '#password-form'); !!}
    @endpush
@endif
