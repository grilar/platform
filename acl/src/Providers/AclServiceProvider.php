...
use Grilar\ACL\Http\Middleware\Authenticate;
use Grilar\ACL\Http\Middleware\RedirectIfAuthenticated;
use Grilar\ACL\Models\Activation;
use Grilar\ACL\Models\Role;
use Grilar\ACL\Models\User;
use Grilar\ACL\Repositories\Eloquent\ActivationRepository;
use Grilar\ACL\Repositories\Eloquent\RoleRepository;
use Grilar\ACL\Repositories\Eloquent\UserRepository;
use Grilar\ACL\Repositories\Interfaces\ActivationInterface;
use Grilar\ACL\Repositories\Interfaces\RoleInterface;
